                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <asp:RequiredFieldValidator ID="Naam" runat="server" ErrorMessage="*" ControlToValidate="txbNaam" ForeColor="red" ValidationGroup='<%#Eval("ID")+"Validation"+ Eval("Naam")%>' Display="Dynamic"></asp:RequiredFieldValidator>
                            ...
                            <asp:Button ID="btnToevoegen" ValidationGroup='<%#Eval("ID")+"Validation"+ Eval("Naam")%>'  CssClass="btnToevoegen" runat="server" CommandName="<%# Container.ItemIndex %>" Text="Toevoegen" OnClick="btnToevoegen_Click" />
