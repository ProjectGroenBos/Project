<%@ Page Title="" Language="C#" MasterPageFile="~/Financien/Financien.Master" AutoEventWireup="true" CodeBehind="Creditnota.aspx.cs" Inherits="ProjectGroenBos.Financien.Creditnota" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header">Creditnota</div>
    <div class="container" runat="server" id="pdfbody">
        <h2>Creditnota-overzicht</h2>
        <p>Dit is een overzicht van alle annuleringen bij recreatiepark Groenbos.</p>


        <asp:GridView ID="gvCreditnota" DataKeyNames="Nummer" CssClass="content-table tweedetable" GridLines="None" runat="server" AutoGenerateColumns="false" DataSourceID="SqlDataSource6" OnSelectedIndexChanged="gvReserveringen_SelectedIndexChanged">
            <Columns>
                <asp:BoundField DataField="Nummer" HeaderText="Reserveringsnummer" InsertVisible="False" SortExpression="Nummer" ReadOnly="True" />
                <asp:BoundField DataField="Betalen aan" HeaderText="Betalen aan" SortExpression="Naam" ReadOnly="True" />
                <asp:BoundField DataField="Totaalbedrag" HeaderText="Totaalbedrag" SortExpression="Aantal_personen" />
                <asp:BoundField DataField="Datum van reservering" DataFormatString="{0:d}" HeaderText="Aankomstdatum" SortExpression="Aankomstdatum" />
                <asp:BoundField DataField="Datum van annulering" DataFormatString="{0:d}" HeaderText="Aankomstdatum" SortExpression="Aankomstdatum" />
                                ...
                                <table class="content-table" style="min-width: 656px; margin-top: -25px">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td style="text-align: right">Restitueren:</td>
                                            <td style="width: 100px">€ <%# Eval("Nogtebetalen") %></td>
                                        </tr>
                                    </tbody>
                                </table>
