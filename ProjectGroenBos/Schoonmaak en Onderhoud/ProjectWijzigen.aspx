<%@ Page Title="Wijzigen Project" Language="C#" AutoEventWireup="true" MasterPageFile="Schoonmaak.Master" CodeBehind="ProjectWijzigen.aspx.cs" Inherits="ProjectGroenBos.Schoonmaak_en_Onderhoud.ProjectWijzigen" %>
<asp:Content ID="ProjectWijzigen" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

            <br />
    <br />
        <br />
    <div class="form-row" style="text-align:center;">
        <h1 class="text-primary">Project Wijzigen</h1>
    <br />
    <br />
    <br />
    </div>
  ...
  <div style="width:65%; margin: 0 auto; text-align:left;">
    ...
    <asp:Label ID="lblBungalownummer" runat="server" Text="Bungalownummer"></asp:Label>
                 ...
                 <tr>
                    <td class="auto-style16">
           <asp:Label ID="lblOmschrijving" runat="server" Text="Bevinding(en)"></asp:Label>
                     </td>
                    <td class="auto-style17">
           &nbsp;<asp:TextBox ID="txtOmschrijving" runat="server" Height="104px" Width="216px" TextMode="MultiLine" ></asp:TextBox>
