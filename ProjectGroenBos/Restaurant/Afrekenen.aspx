<%@ Page Title="" Language="C#" MasterPageFile="~/Restaurant/Restaurant.Master" AutoEventWireup="true" CodeBehind="Afrekenen.aspx.cs" Inherits="ProjectGroenBos.Restaurant.Afrekenen" %>
        ...
        <div class="werkgebied">
            ...
            <div class="Factuurregelbak">
                <asp:GridView class="GvOrder" ID="GvOrder" runat="server" AutoGenerateColumns="False" DataSourceID="factuurregels" AllowSorting="True" GridLines="None" DataKeyNames="Hoeveel,Prijs,Item_ID">
                    <Columns>
                        <asp:BoundField DataField="Hoeveel" HeaderText="Hoeveel" SortExpression="Hoeveel"></asp:BoundField>
                        <asp:BoundField DataField="Naam" HeaderText="Naam" SortExpression="Naam"></asp:BoundField>
                        <asp:BoundField DataField="Prijs" HeaderText="Prijs" SortExpression="Prijs"></asp:BoundField>
                        <asp:BoundField DataField="RegelTotaal" HeaderText="RegelTotaal" ReadOnly="True" SortExpression="RegelTotaal" />
                        <asp:BoundField DataField="Item_ID" HeaderText="Item_ID" SortExpression="Item_ID" Visible="False"></asp:BoundField>
