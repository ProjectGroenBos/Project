...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   ...
   <br />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="content-table" DataKeyNames="Volgnummer,Reservering Nummer" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="Reservering Nummer" HeaderText="Reservering Nummer" ReadOnly="True" SortExpression="Reservering Nummer" />
            </Columns>
        </asp:GridView>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:2020-BIM02-P1-P2-GroenbosConnectionString %>" SelectCommand="SELECT [volgnummer] as [Volgnummer], [Voornaam], [Tussenvoegsel], [Achternaam], [Geboortedatum], [ReserveringNummer2] as [Reservering Nummer] FROM [Nachtregister] WHERE ([ReserveringNummer2] = @ReserveringNummer2)">
            <SelectParameters>
                <asp:ControlParameter ControlID="lblReserveringnummer" Name="ReserveringNummer2" PropertyName="Text" />
            </SelectParameters>
        </asp:SqlDataSource>
