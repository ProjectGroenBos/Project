...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <p>
        <asp:Label ID="Label2" runat="server" Text="Naam:" CssClass="labelsnieuw"></asp:Label>
    ...
    <p>
        <asp:Label ID="Label1" runat="server" Text="Tussenvoegsel:" CssClass="labelsnieuw"></asp:Label><asp:TextBox ID="TxBtussenvoegsel" runat="server" CssClass="textboxchaos"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>
        <asp:Button ID="btnBevestigen" runat="server" Click="btnBevestigen_Click1" Text="Bevestigen" OnClick="btnBevestigen_Click" CssClass="textboxbtn" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnToevoegen" runat="server" OnClick="btnToevoegen_Click1" Text="Toevoegen" CssClass="textboxbtn" />
    </p>
    </form>
    </body>
</asp:Content>
