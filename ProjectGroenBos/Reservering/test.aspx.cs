...
namespace ProjectGroenBos.Reservering
{
    public partial class test : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("ReserveringenwijzigenMASTER.aspx");
            }
            else
            {
        ...
        protected void btnWijzigen_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["2020-BIM02-P1-P2-GroenbosConnectionString"].ConnectionString))
                {
                    ...
                    string aantalPersonen = txbAantalPersonen.Text;
                    string opmerkingen = txbOpmerkingen.Text;
                    string aankomstdatum = txbAankomstdatum.Text;
                    string vertrekdatum = txbVertrekdatum.Text;
                    ...
                    int veranderRij1 = cmd1.ExecuteNonQuery();
                    int veranderRij2 = cmd2.ExecuteNonQuery();

                    con.Close();

                    int totaal = veranderRij1 + veranderRij2;
                    Response.Redirect("ReserveringenwijzigenMASTER.aspx");
                }
