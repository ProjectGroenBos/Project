...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <tr>
        ...
        <asp:Label ID="lblStorten" runat="server" CssClass="labelsnieuw"></asp:Label>
         ...
         <tr>
    <td style="width: 15%">
    <asp:Button ID="btnverwijderen" runat="server" Text="Annuleren" CssClass="btnUitloggen" OnClick="btnWijzigen_Click" Style="background-color: #009879; color: #fff" class="btn"/>
        </td>
    </tr>
