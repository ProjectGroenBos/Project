...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txbVoornaam" ErrorMessage="In een voornaam staan geen getallen." CssClass="validators" ValidationExpression="^[a-zA-Z -]*$"></asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txbTussenvoegsel" ErrorMessage="In een tussenvoegsel kunnen geen cijfers zitten." CssClass="validators" ValidationExpression="^[a-zA-Z -]*$"></asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txbAchternaam" ErrorMessage="In een achternaam staan geen getallen." CssClass="validators" ValidationExpression="^[a-zA-Z -]*$"></asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txbTelefoonnummer" ErrorMessage="Telefoonnummer bestaat uit 9 getallen. De eerste 0 kan worden weggelaten." CssClass="validators" ValidationExpression="^[0-9]{9}$"></asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txbEmail" ErrorMessage="Email is niet geldig" CssClass="validators" ValidationExpression="[a-z0-9!#$%&'+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'+/=?^_`{|}~-]+)@(?:[a-z0-9](?:[a-z0-9-][a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?"></asp:RegularExpressionValidator>
    ...
    <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txbGeboortedatum" ErrorMessage="U bent geen 18 jaar oud." CssClass="validators"></asp:CustomValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txbWoonplaats" ErrorMessage="In een woonplaats staan geen getallen." CssClass="validators" ValidationExpression="^[a-zA-Z -]*$"></asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txbStraatnaam" ErrorMessage="In een straatnaam staan geen getallen." CssClass="validators" ValidationExpression="^[a-zA-Z -]*$"></asp:RegularExpressionValidator>
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txbHuisnummer" ErrorMessage="In een huisnummer staan alleen getallen met eventuele toevoeging." CssClass="validators" ValidationExpression="^[A-Za-z0-9 ]+$"></asp:RegularExpressionValidator>
